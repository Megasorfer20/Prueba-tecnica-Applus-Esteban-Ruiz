...
{ ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que quieres Eliminar este Producto?<br />
    ...
    <script>
        document.getElementById('delCategoryForm<?= $id ?>').addEventListener('submit', function (event) {
            ...
            fetch(`http://localhost/Prueba-tecnica-Applus/Creacion-Cruds/backend/controller/product.controller.php?act=delete&id=<?= $id ?>`, {
                method: 'POST',
                body: formData
            })
